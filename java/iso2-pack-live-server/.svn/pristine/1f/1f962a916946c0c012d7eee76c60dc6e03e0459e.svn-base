/*
  code for declaration of data elements
  @author
  bhushan shirsath
  ...
  This class declares the Data Elements of the iso8583 message
  
- Fields eg. new IFA_NUMERIC(lenght, de) 
...
public class ISO93Packeger extends ISOBasePackager{
	...
	{ 
			...
			/*008*/ new IFA_NUMERIC ( 6, "AMOUNT, CARDHOLDER BILLING FEE"),
		    ...
		    /*045*/new IFA_LLCHAR (25,"ADITIONAL RESPONSE DATA"),
			...
			/*050*/new IF_CHAR(3,"CURRENCY CODE, TRANSACTION"),
		//	/*051*/new IF_CHAR(3,"CURRENCY CODE, TRANSACTION"),
			...
			/*055*/new IFA_LLLCHAR(999,"ADITIONAL DATA - PRIVATE"),
			/*056*/new IFA_LLLCHAR(999,"ADITIONAL DATA - PRIVATE"),
			...
			/*072*/new IFA_NUMERIC ( 4, "MESSAGE NUMBER"),
			...
			/*102*/new IFA_LLLCHAR(28,"ACCOUNT IDENTIFICATION 1"),
			/*103*/new IFA_LLLCHAR(28,"ACCOUNT IDENTIFICATION 2"),
